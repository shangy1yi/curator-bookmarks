...
- 当前集成代码状态：在 `d01d8b3` 基础上继续补齐 newtab 书签编辑菜单项上下文；报告最新提交以 `git log -1 --oneline` 为准。
...
28. newtab 候选文件夹 listbox 缺少方向键导航
   - 页面/组件位置：newtab 设置抽屉 / 文件夹来源候选列表
