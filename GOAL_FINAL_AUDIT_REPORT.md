...
- 当前集成代码状态：在 `f7f3b4c` 基础上继续补齐重复书签批量选择按钮上下文；报告最新提交以 `git log -1 --oneline` 为准。
...
27. newtab 候选文件夹 listbox 可访问名称不稳定
   - 页面/组件位置：newtab 设置抽屉 / 文件夹来源候选列表
...
29. newtab 删除提示动作按钮可访问名称缺少书签上下文
...
33. newtab 候选文件夹 listbox 缺少方向键导航
   - 页面/组件位置：newtab 设置抽屉 / 文件夹来源候选列表
