...
- 当前集成代码状态：在 `590311a` 基础上继续补齐 Dashboard 批量选择按钮上下文；报告最新提交以 `git log -1 --oneline` 为准。
...
23. newtab 候选文件夹 listbox 可访问名称不稳定
   - 页面/组件位置：newtab 设置抽屉 / 文件夹来源候选列表
...
25. newtab 删除提示动作按钮可访问名称缺少书签上下文
...
29. newtab 候选文件夹 listbox 缺少方向键导航
   - 页面/组件位置：newtab 设置抽屉 / 文件夹来源候选列表
